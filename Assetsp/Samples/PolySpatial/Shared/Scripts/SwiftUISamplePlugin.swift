...
// Used in Unity 6000.4 and greater where EntityID is 8 bytes.
var lastObjectEntityId: UInt64 = 0
...
// Declared in C# as: static extern void SetLastObjectEntityId(ulong instanceId);
@_cdecl("SetLastObjectEntityId")
func SetLastObjectEntityId(_ entityId: UInt64)
{
    lastObjectEntityId = entityId
}
...
// Called by button callbacks in HelloWorldContentView for Unity 6000.4 and greater
public func GetLastObjectEntityId() -> UInt64 {
    return lastObjectEntityId
}
