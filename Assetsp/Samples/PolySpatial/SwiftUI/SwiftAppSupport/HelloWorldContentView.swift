    ...
    var body: some View {
        VStack {
            ...
            Button("Make It Pink") {
                ...
                if instanceId == 0 {
                    // In this path we are running on Unity 6000.4 where EntityIds are 64 bits.
                    let entityIdUint = GetLastObjectEntityId()
                    let entities = PolySpatialWindowManagerAccess.entitiesForUnityEntityId(id: entityIdUint)
